...
if(!empty($_POST['name']) && !empty($_POST['phone'])) {
    ...
    $res = file_get_contents("https://ep.smartad.digital/api/lead/30/2?sub3=".$_SERVER['SERVER_NAME']."&sub2=85&sub4=4&sub5=5",false, stream_context_create(['http' =>
        [
            'method' => 'POST',
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109026122-6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-109026122-6');
</script>
